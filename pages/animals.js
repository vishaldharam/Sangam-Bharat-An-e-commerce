   ...
   <div className="container mt-2 sm:py-2 py-0 bg-white px-2 mx-auto">
       ...
       {/* <div id="slider" className='  py-0 w-full m-auto h-full scrollbar-hide overflow-x-scroll scroll whitespace-nowrap scroll-smooth'> */}
         ...
         <Link href={'/dog'}><div className='md:w-[120px] rounded-sm md:h-[70px] w-[100px] h-[80px] inline-block p- md:p-0 m-2 sm:mx-10 md:ml-4 cursor-pointer hover:scale-105 ease-in-out duration-300 bg-white  rounded-b-lg'>
           <img src={'da.jpg'} className='w-[120px]  rounded-sm md:h-[80px] h-[60px]' alt='' ></img>
           <p className="text-center sm:mt-0  mt-1 title-font text-md font-medium">Dog</p>
         ...
         <Link href={'/dog'}><div className='md:w-[120px] rounded-sm md:h-[70px] w-[100px] h-[80px] inline-block p- md:p-0 m-2 sm:mx-10 md:ml-2 cursor-pointer hover:scale-105 ease-in-out duration-300 bg-white  rounded-b-lg'>
           <img src={'cat.jpg'} className='w-[120px]  rounded-sm md:h-[80px] h-[60px]' alt='' ></img>
           <p className="text-center sm:mt-0  mt-1 md:mt-0 title-font text-md font-medium">Cat</p>

         </div></Link>
         <Link href={'/Animals/Cows'}><div className='md:w-[120px] rounded-sm md:h-[70px] w-[100px] h-[80px] inline-block p- md:p-0 m-2  sm:mx-10 md:ml-2 cursor-pointer hover:scale-105 ease-in-out duration-300 bg-white  rounded-b-lg'>
           <img src={'cow.jpg'} className='w-[120px]  rounded-sm md:h-[80px] h-[60px]' alt='' ></img>
           <p className="text-center sm:mt-0  mt-1 title-font text-md font-medium">Cow</p>

         </div></Link>
         <Link href={'/dog'}><div className='md:w-[120px] rounded-sm md:h-[70px] w-[100px] h-[80px] inline-block p- md:p-0 m-2 sm:mx-10 md:ml-2 cursor-pointer hover:scale-105 ease-in-out duration-300 bg-white  rounded-b-lg'>
           <img src={'buff.webp'} className='w-[120px]  rounded-sm md:h-[80px] h-[60px]' alt='' ></img>
           <p className="text-center sm:mt-0  mt-1 title-font text-md font-medium">Buffalo</p>

         </div></Link>
         <Link href={'/dog'}><div className='md:w-[120px] rounded-sm md:h-[70px] w-[100px] h-[80px] inline-block p- md:p-0 m-2 sm:mx-10 md:ml-2 cursor-pointer hover:scale-105 ease-in-out duration-300 bg-white  rounded-b-lg'>
           <img src={'horse.jpg'} className='w-[120px]  rounded-sm md:h-[80px] h-[60px]' alt='' ></img>
           <p className="text-center sm:mt-0  mt-1 title-font text-md font-medium">Horse</p>

         </div></Link>
         <Link href={'/dog'}><div className='md:w-[120px] rounded-sm md:h-[70px] w-[100px] h-[80px] inline-block p- md:p-0 m-2 sm:mx-10 md:ml-2 cursor-pointer hover:scale-105 ease-in-out duration-300 bg-white  rounded-b-lg'>
           <img src={'goat.jpg'} className='w-[120px]  rounded-sm md:h-[80px] h-[60px]' alt='' ></img>
           <p className="text-center sm:mt-0  mt-1 title-font text-md font-medium">Goat</p>

         </div></Link>
         <Link href={'/dog'}><div className='md:w-[120px] rounded-sm md:h-[70px] w-[100px] h-[80px] inline-block p- md:p-0 m-2 sm:mx-10 md:ml-2 cursor-pointer hover:scale-105 ease-in-out duration-300 bg-white  rounded-b-lg'>
           <img src={'sheep.jpg'} className='w-[120px]  rounded-sm md:h-[80px] h-[60px]' alt='' ></img>
           <p className="text-center sm:mt-0  mt-1 title-font text-md font-medium">Sheep </p>
   ...
   <div className="flex flex-wrap -m-4 bg-slate-50 justify-center ">
     ...
     {Object.keys(data).map((item)=>{ return (<><div key={data[item].slug} className="lg:w-1/5 bg-white md:w-1/2 px-2 py-2 md:px-3 md:py-3 rounded shadow-md m-4   w-full">
       ...
       <Link href={`product/${data[item].slug}`}>
         <img alt="ecommerce" className=" object-fill p-1 w-full h-full block" src={`images/${data[item].images[0]}`}/></Link>
       </div>
